...
<div class="page-home">
  ...
  <section>
    ...
    <div class="card-grid card-grid--two">
      ...
      <article class="section-card">
        <span class="subtle-label">Archive</span>
        <h3>PapersWithCode Catalog</h3>
        <p>Inspect the structured archive ingest workflow for PapersWithCode snapshots, with provenance and enrichment-ready metadata.</p>
        <div class="section-card__meta">
          <a class="pill" href="pwc/">Open archive catalog</a>
        </div>
      </article>
